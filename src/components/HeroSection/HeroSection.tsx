...
const HeroSection = () => {
  return (
    <>
      ...
      <section
        id="hero-container"
        className="relative mx-auto mt-1 w-[98%] h-[700px] overflow-hidden max-w-[1490px] hidden lg:block"
      >
        {/* left section */}
        <div
      ...
      <section className="flex flex-col items-center justify-center text-center p-4 lg:hidden">
        {/* top button */}
        <button className="border-2 border-gray-400 rounded-full px-4 py-2 flex items-center justify-center gap-2 mb-4">
          All Glow In One Solution
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
        ...
        {/* main heading */}
        <h1 className="text-[38px] sm:text-[48px] font-libre font-medium leading-tight mb-6">
          Empowering
          <br />
          Confidence In
          <br />
        ...
        <img
          src={curvedImage}
          className="w-[90%] max-w-[400px] object-contain mb-6"
          alt="Skincare model"
        />

        {/* overlay content converted into stacked card */}
        <div className="text-white bg-black/80 rounded-2xl py-6 px-4 w-[90%] max-w-[400px]">
          ...
          <p className="opacity-70 mb-4">See Our Latest Products</p>

          <img
            src={blankImage}
            className="h-[120px] mx-auto mb-3"
            alt="product"
          />
